...
int RightMost(BinaryTree<int> *bt) {
    if(bt->right() == NULL) 
    {
        // Base case: this is the rightmost node
        return bt->getData();
    } 
    else 
    {
        // Recursive case: keep moving to the right
        return RightMost(bt->right());
    }
    
}

int LeftMost(BinaryTree<int> *bt) {
    if(bt->left() == NULL) 
    {
        // Base case: this is the rightmost node
        return bt->getData();
